<template>
  ...
  style="width: 100%; height: 100%;"></iframe>
    ...
    <div class="popup" v-show="popupVisible && !pdfElementId === 'draged-div'">
      <input
        type="checkbox"
        v-model="description"
        placeholder="Enter description"
      ...
      <button id="popupClose" @click="closePopup">Close</button>
          ...
          <div id="pdfSaveBtn" class="flex mx-auto my-20">
            ...
            <br/> X-Position: {{ startX}} 
            <br/> Y-Position: {{startY }} 
            </div>
          </div>
        </div>
      </div>
...
let print_pdf = createListResource({
